...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = $conn->prepare($sql)){
            ...
            // Creates a password hash this is a php inbuild password_hash() function creates a password hash using a strong one-way hashing algorithm. 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                         ...
                         <a class="btn btn-md hovar-top btn-primary" href="dashboard.php">Back, Dashboard</a>
                         <hr>
                            </div>
                            <div class="text-center">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Username" name="" required maxlength="6">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="email" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="Email Address" name="" required>
                                    </div>
                                </div>
                                <!--<div class="form-group">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Password" name="" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
